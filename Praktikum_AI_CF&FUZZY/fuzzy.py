...
Original file is located at
    https://colab.research.google.com/drive/1S6rMlopRwDeW1qe0RF0VdKMt5hfyB5k1
"""
...
input_suhu = 22
#jika mengubah nilai input_suhu dari 37.2 -> 22 ini akan bernilai 0 karena bernilai salah atau tidak benar, karena suhu 22 ini tidak dalam rentang set suhu tubuh aturan fuzzy dari 35 - 40 derajat sehingga dihasilkan 0.00.
...
print("Derajat keanggotaan AQI {input_aqi}:")
...
rule10 = ctrl.Rule(temperature['panas'] & humidity['normal'], fan_speed['sedang'])
# menambahkan aturan rule10 jika panas dan normal maka kipas sedang
...
# Compute result
ac.compute()
print(f"Untuk suhu 28°C dan kelembaban 75%, kecepatan kipas AC: {ac.output['fan_speed']:.2f}%")
#suhu 28 berada di ujung kanan fuzzy set "nyaman" dan masuk ke awal fuzzy set "panas" yang berarti nilai suhu 28°C memiliki dua derajat keanggotaan di dua kategori berbeda.
# Visualize result
